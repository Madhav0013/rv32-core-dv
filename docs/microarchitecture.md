...
| Traps / exceptions | Illegal instruction, misaligned load/store, ECALL, EBREAK | These four are what the architectural suite actually exercises at M-mode. Interrupts are out of scope. |
