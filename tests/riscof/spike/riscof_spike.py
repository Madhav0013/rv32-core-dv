...
class spike(pluginTemplate):
    ...
    def runTests(self, testList, cgf_file=None):
        ...
        for file in testList:
            ...
            cmd = self.compile_cmd + ' -march=' + testentry['isa'].lower() + ' ' + test + ' -o ' + elf
            ...
            execute += self.ref_exe + ' --isa={0} +signature={1} +signature-granularity=4 {2}'.format(testentry['isa'].lower(), sig_file, elf)
